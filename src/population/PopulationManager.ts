...
const FITNESS_SURVIVAL_BONUS = 22;
const FITNESS_EARLY_CRASH_WINDOW_SECONDS = 6;
const FITNESS_EARLY_CRASH_PENALTY = 140;
const FITNESS_LATERAL_OFFSET_PENALTY = 0.25;
const FITNESS_STEERING_PENALTY = 22;
const FITNESS_STAGNATION_PENALTY = 48;
const FITNESS_FORWARD_SPEED_BONUS = 50;
const FITNESS_EDGE_PROXIMITY_PENALTY = 85;
const FITNESS_FRONT_OBSTACLE_PENALTY = 65;
const FITNESS_SAFE_AVOIDANCE_REWARD = 110;
const FITNESS_LANE_OFFSET_PENALTY = 0.45;
const FITNESS_LANE_RECOVERY_REWARD = 280;
const FITNESS_SUSTAINED_STEER_PENALTY = 68;
const FITNESS_LANE_ALIGNMENT_REWARD = 120;
const FITNESS_STEERING_OSCILLATION_PENALTY = 100;
...
const STRONG_STEER_GRACE_SECONDS = 0.3;
const LANE_RECOVERY_EPSILON = 0.8;
